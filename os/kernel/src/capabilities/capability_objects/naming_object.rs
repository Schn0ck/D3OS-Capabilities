...
impl NamingObject {
    fn new(object: NamedObject, rights: OpenOptions, parent: Option<usize>) -> Self {
        Self {
...
pub fn create_naming_capability(object: NamedObject, rights: OpenOptions, parent: Option<usize>) -> Capability<NamingObject> {
